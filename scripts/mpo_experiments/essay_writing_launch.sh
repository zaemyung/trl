...
#     --wandb_entity "iterater" \
#     --wandb_project "mpo-new" \
#     --exp_name "ew-mpo-72b_72b" \
#     --init_rm_prompt $trl_dir/trl/extras/mpo/prompts/essay_writing/evaluation_rubric_real_iter_0.txt \
#     --output_dir $trl_dir/models/essay_writing/mpo/72b_72b \
#     --learning_rate 3e-6 \
#     --num_ppo_epochs 4 \
#     --num_mpo_interval 20 \
#     --num_mpo_samples 20 \
...
#     --wandb_entity "iterater" \
#     --wandb_project "mpo-new" \
#     --exp_name "ew-mpo-32b_72b" \
#     --init_rm_prompt $trl_dir/trl/extras/mpo/prompts/essay_writing/evaluation_rubric_real_iter_0.txt \
#     --output_dir $trl_dir/models/essay_writing/mpo/32b_72b \
#     --learning_rate 3e-6 \
#     --num_ppo_epochs 4 \
#     --num_mpo_interval 20 \
#     --num_mpo_samples 20 \
...
#     --wandb_entity "iterater" \
#     --wandb_project "mpo-new" \
#     --exp_name "ew-mpo-72b_32b" \
#     --init_rm_prompt $trl_dir/trl/extras/mpo/prompts/essay_writing/evaluation_rubric_real_iter_0.txt \
#     --output_dir $trl_dir/models/essay_writing/mpo/72b_32b \
#     --learning_rate 3e-6 \
#     --num_ppo_epochs 4 \
#     --num_mpo_interval 20 \
#     --num_mpo_samples 20 \
...
#     --wandb_entity "iterater" \
#     --wandb_project "mpo-new" \
#     --exp_name "ew-mpo-32b_32b" \
#     --init_rm_prompt $trl_dir/trl/extras/mpo/prompts/essay_writing/evaluation_rubric_real_iter_0.txt \
#     --output_dir $trl_dir/models/essay_writing/mpo/32b_32b \
#     --learning_rate 3e-6 \
#     --num_ppo_epochs 4 \
#     --num_mpo_interval 20 \
#     --num_mpo_samples 20 \
...
#     --wandb_entity "iterater" \
#     --wandb_project "mpo-new" \
#     --exp_name "ew-ppo-iter0-32b" \
#     --init_rm_prompt $trl_dir/trl/extras/mpo/prompts/essay_writing/evaluation_rubric_real_iter_0.txt \
#     --output_dir $trl_dir/models/essay_writing/ppo/iter0-32b \
#     --learning_rate 3e-6 \
#     --num_ppo_epochs 4 \
#     --num_mpo_interval 99999999 \
#     --num_mpo_samples 20 \
...
CUDA_VISIBLE_DEVICES=0,1,2,3 accelerate launch --config_file $trl_dir/examples/accelerate_configs/deepspeed_zero2_4gpus.yaml \
    ...
    --wandb_entity "iterater" \
    --wandb_project "mpo-new" \
    --exp_name "ew-ppo-iter0-72b" \
    --init_rm_prompt $trl_dir/trl/extras/mpo/prompts/essay_writing/evaluation_rubric_real_iter_0.txt \
    --output_dir $trl_dir/models/essay_writing/ppo/iter0-72b \
    --learning_rate 3e-6 \
    --num_ppo_epochs 4 \
    --num_mpo_interval 99999999 \
    --num_mpo_samples 20 \
...
CUDA_VISIBLE_DEVICES=0,1,2,3 accelerate launch --config_file $trl_dir/examples/accelerate_configs/deepspeed_zero2_4gpus.yaml \
    ...
    --wandb_entity "iterater" \
    --wandb_project "mpo-new" \
    --exp_name "ew-ppo-oracle-72b" \
    --init_rm_prompt $trl_dir/trl/extras/mpo/prompts/essay_writing/evaluation_rubric_oracle.txt \
    --output_dir $trl_dir/models/essay_writing/ppo/oracle-72b \
    --learning_rate 3e-6 \
    --num_ppo_epochs 4 \
    --num_mpo_interval 99999999 \
    --num_mpo_samples 20 \
